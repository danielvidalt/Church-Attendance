...
import { Language, esTranslations, enTranslations, Configuracion, EventTrack } from '../types';
import { Settings, Check, RefreshCw, AlertTriangle, ShieldCheck, Plus, Trash2 } from 'lucide-react';
